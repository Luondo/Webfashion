...
namespace Webfashion
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<Product> sp6 = new List<Product>();
            foreach (Product sp in ProductList)
            {
                string id = sp.Id;
                if (id == "1" || id == "10" || id == "2" || id == "3" || id == "11" || id == "12")
                {
                    sp1.Add(sp);
                }
                if (id == "4" || id == "5" || id == "13"|| id == "3" || id == "11" || id == "12")
                {
                    sp2.Add(sp);
                }
                if (id == "2" || id == "10" || id == "12" || id == "4" || id == "5" || id == "6")
                {
                    sp3.Add(sp);
                }
                if (id == "2" || id == "10" || id == "12" || id == "4" || id == "5" || id == "6")
